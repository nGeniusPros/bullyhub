      ...
      <div className="min-w-[900px] p-6">
        <div className="flex flex-col">
          ...
          <div className="flex justify-between">
            <div className="flex-1 flex justify-center">
              {pedigree.sire?.sire ? (
                <DogCard dog={pedigree.sire.sire.dog} />
              ) : (
            ...
            <div className="flex-1 flex justify-center">
              {pedigree.sire?.dam ? (
                <DogCard dog={pedigree.sire.dam.dog} />
              ) : (
            ...
            <div className="flex-1 flex justify-center">
              {pedigree.dam?.sire ? (
                <DogCard dog={pedigree.dam.sire.dog} />
              ) : (
                <EmptyDogCard label="Grandsire Unknown" />
              )}
            </div>
            <div className="flex-1 flex justify-center">
              {pedigree.dam?.dam ? (
                <DogCard dog={pedigree.dam.dam.dog} />
              ) : (
                <EmptyDogCard label="Granddam Unknown" />
              )}
            </div>
    ...
    >
      ...
      <div className="p-3">
        ...
        {dog.registration_number && (
          <p className="text-sm text-gray-500">#{dog.registration_number}</p>
        )}
        {dog.color && (
          <div className="mt-2">
