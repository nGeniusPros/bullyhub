...
import { useGalleryQueries } from "../data/queries";
import { GalleryImageUploadData } from "../types";
...
export function ImageUpload({
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setIsUploading(true);
    try {
      // Use the gallery queries to upload the image
      ...
      const image = await galleryQueries.uploadImage(uploadData);
